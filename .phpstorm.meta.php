...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/bryandease/Herd/food_inventory/public/storage' => 'string',
            ...
            'services.google.credentials_b64' => 'string',
            'services.google.sheets.sheet_id' => 'string',
            'services.google.sheets.sheet_tab' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/bryandease/Herd/food_inventory/public/storage','logging.default','logging.deprecations.channel',
...
'services.ses.region','services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.google.credentials_b64','services.google.sheets.sheet_id',
'services.google.sheets.sheet_tab','session.driver','session.lifetime','session.expire_on_close','session.encrypt',
...
'cors.max_age','cors.supports_credentials','livewire.class_namespace','livewire.view_path','livewire.layout',
...
'prism.prism_server.middleware','prism.prism_server.enabled','prism.providers.openai.url','prism.providers.openai.api_key','prism.providers.openai.organization',
'prism.providers.openai.project','prism.providers.anthropic.api_key','prism.providers.anthropic.version','prism.providers.anthropic.default_thinking_budget','prism.providers.anthropic.anthropic_beta',
...
'prism.providers.deepseek.url','prism.providers.voyageai.api_key','prism.providers.voyageai.url','ide-helper.filename','ide-helper.models_filename',
...
'livewire.update','livewire.upload-file','livewire.preview-file','freezer.add','freezer.remove','freezer.check',
'freezer.list','freezer.openai','home','dashboard','settings.profile','settings.password','settings.appearance','login',
...
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','GOOGLE_APPLICATION_CREDENTIALS_B64',
